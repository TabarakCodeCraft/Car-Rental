...
const ListCar = () => {
  ...
  return (
    <div className="md:px-8 py-6 xl:py-8 m-1 sm:m-3 h-[97vh] overflow-y-scroll lg:w-11/12 bg-white shadow rounded-xl">
      <div className="mt-4">
        <div
          className="flex justify-between flex-wrap gap-2 sm:grid sm:grid-cols-[2fr_2fr_1fr_1fr] 
        lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-solid text-white border-b-1 border-slate-900/10 rounded-t-xl"
        >
        ...
        <div>
          {cars.map((car, index) => (
            <div
              key={index}
              className="flex justify-between items-center flex-wrap gap-2 sm:grid sm:grid-cols-[2fr_2fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-primary
               text-gray-400 text-sm font-semibold border-b-1 border-slate-900/10"
            >
              ...
              <div>
                ...
                >
                  ...
                  />
                  <div className="w-10 h-6 bg-slate-300 rounded-full peer-checked:bg-solid transition-colors duration-200"></div>
